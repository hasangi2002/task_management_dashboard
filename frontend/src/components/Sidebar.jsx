...
const Sidebar = ({ isMobileOpen, onClose }) => {
  ...
  const navItems = [
    { name: 'Dashboard', path: `/project/${projectId}`, icon: LayoutDashboard, end: true },
    { name: 'Tasks', path: `/project/${projectId}/tasks`, icon: CheckSquare },
    { name: 'KPI Analytics', path: `/project/${projectId}/analytics`, icon: BarChart3 },
    { name: 'Team', path: `/project/${projectId}/team`, icon: Users },
    { name: 'Calendar', path: `/project/${projectId}/calendar`, icon: CalendarIcon },
    { name: 'Monthly Reviews', path: `/project/${projectId}/monthly-reviews`, icon: Layers },
